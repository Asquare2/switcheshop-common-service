...
public class Utility {
  ...
  public static ReturnDetailDto convertModelToDto(ReturnDetail model) {
    ...
    dto.setPickupScheduledDate(model.getPickupScheduledDate());
    ...
    dto.setCreatedAt(com.lgitsolution.switcheshopcommon.common.util.Utility.getLocalDateTimeMillis(
            model.getCreatedAt()));
    return dto;
  }
  ...
  public static ReturnDetail convertDtoToModel(ReturnDetailDto dto) {
    ...
    model.setPickupScheduledDate(dto.getPickupScheduledDate());
