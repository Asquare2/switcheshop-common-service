...
package com.lgitsolution.switcheshop.order.utility;

import java.util.List;

import com.lgitsolution.switcheshop.order.dto.OrderDetailsDto;
import com.lgitsolution.switcheshop.order.dto.OrderItemsDto;
import com.lgitsolution.switcheshop.order.model.OrderDetails;
import com.lgitsolution.switcheshop.order.model.OrderItems;
...
public class Utility {
  ...
  public static OrderDetails convertDtoToModel(OrderDetailsDto orderDetilsDto) {
    ...
    orderDetails.setCreatedAt(
            com.lgitsolution.switcheshop.common.util.Utility
