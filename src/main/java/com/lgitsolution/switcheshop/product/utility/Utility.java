...
package com.lgitsolution.switcheshop.product.utility;

import java.util.List;

import com.lgitsolution.switcheshop.product.dto.ProductDto;
import com.lgitsolution.switcheshop.product.model.Product;
...
public class Utility {
  ...
  public static Product convertDtoToModel(ProductDto dto) {
    ...
    skuList.stream().forEach(o -> {
      model.getSkuList().add(
              com.lgitsolution.switcheshop.sku.utility.Utility
                      .convertDtoToModel(o));
    });
    ...
    model.setFaq(com.lgitsolution.switcheshop.common.util.Utility
  ...
  public static ProductDto convertModelToDto(Product model) {
    ...
    dto.setFaq(com.lgitsolution.switcheshop.common.util.Utility
